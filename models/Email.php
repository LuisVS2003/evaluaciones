...
enviarMail("villegasalazar08@gmail.com","Recuperar contraseña", "123456");	
...
function enviarMail($emailDestino = "", $asunto = "", $mensaje=""){
  ...
  try {
      ...
      $mail->Username   = 'villegasalazar08@gmail.com';                     //SMTP username
      $mail->Password   = 'dzjzfcktciljhpzb';                               //SMTP password
